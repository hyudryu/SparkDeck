          ...
          <div className="settings-fields">
            ...
            <div className="community-consent-control wide-field">
              <div>
                ...
                <span id="community-telemetry-description" className="muted">Share canonical model name, quantization, C1 output speed, context size, concurrency, and a stable opaque cluster ID used to count unique contributors. Prompts and responses never leave your cluster.</span>
